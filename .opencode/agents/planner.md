---
name: planner
description: Decomposes chunks of work into epochs and stages for the pera OCaml project, following decomposition rules, test requirements, and reuse audits.
mode: primary
---

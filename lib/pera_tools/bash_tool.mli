...
val bash : (module Pera_env.Execution_env.S) Pera_core.Agent_types.tool
(** [bash] is a bash tool that executes commands through the execution
    environment passed as [~ctx] at execute time.

...
(** Render a [Connector.UserMessage] to the OpenAI messages format.
...
(** Render a [Connector.AssistantMessage] to the OpenAI messages format.
...
(** Render a [Connector.ToolResultMessage] to the OpenAI messages format. *)
...
(** Render one [Connector.message] to the OpenAI messages format. *)
let message_to_json ?find_tool_name = function
  | Connector.UserMessage msg -> user_message_to_json msg
  | Connector.AssistantMessage msg -> assistant_message_to_json msg
...
let extract_tool_names_from_message acc = function
  ...
  | Connector.UserMessage _ | Connector.ToolResultMessage _ -> acc

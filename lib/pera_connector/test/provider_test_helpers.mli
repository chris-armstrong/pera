...
val make_context :
  Pera_connector.Connector.message list -> Pera_connector.Connector.context
(** [make_context messages] builds a minimal [Connector.context] wrapping
...
val make_options :
  ...
  unit ->
  Pera_connector.Connector.simple_stream_options
(** [make_options ()] builds a minimal [Connector.simple_stream_options] with
...
val make_tool_result :
  ?is_error:bool -> string -> string -> Pera_connector.Connector.message

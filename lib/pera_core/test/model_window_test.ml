...
let test_default_trigger_tokens () =
  ...
  in
  Alcotest.(check int)
    "default trigger tokens" 140_000
    ...
    [
      ( "for_model",
        [
          ...
          Alcotest.test_case "respects_variant" `Quick
            test_for_model_respects_variant;
          Alcotest.test_case "openai_compatible" `Quick
            test_for_model_openai_compatible;
        ] );
      ( "default_trigger_tokens",
        [
          Alcotest.test_case "default" `Quick test_default_trigger_tokens;
          Alcotest.test_case "custom_ratio" `Quick
            test_default_trigger_tokens_custom_ratio;
        ] );
    ]

...
(** Compatibility configuration for provider-specific API fields.
    All fields are optional; [None] means the provider uses defaults. *)
...
(** Specification for a single model.
    ...
    - [thinking]: optional thinking budget spec. [None] means no thinking support. *)
